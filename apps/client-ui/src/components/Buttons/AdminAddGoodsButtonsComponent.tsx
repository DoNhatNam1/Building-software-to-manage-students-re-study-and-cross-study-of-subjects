...
import AdminAddServiceFormComponent from "../Forms/AdminAddServicesFormComponent";
import AdminAddGoodsFormComponent from "../Forms/AdminAddGoodsFormComponent";
    ...
    <>
      ...
      {open === "Product" && (
        ...
        <div className="h-full grid place-content-center">
          ...
          <div className="h-full bg-white pt-10 px-10">
                <AdminAddGoodsFormComponent setOpen={setOpen} />
              </div>
          </div>
        </div>
      </div>
      ...
      {open === "Service" && (
        ...
        <div className="h-full grid place-content-center">
          ...
          <div className="h-full bg-white pt-10 px-10">
                <AdminAddServiceFormComponent setOpen={setOpen} />
              </div>
          </div>
        </div>
      </div>
