...
const AdminAddServiceFormComponent: any = ({
  setOpen,
}: {
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
            ...
            <div className="flex flex-col">
              ...
              {!show ? (
                <AiOutlineEyeInvisible
                  className="translate-y-2 z-1 cursor-pointer text-black"
                  size={20}
        ...
        <div className="flex justify-end pr-5 gap-2">
          ...
          >
            ...
            <span className='-translate-y-[2px]'>Lưu</span>
          </button>
          <button
            type="button"
          ...
          >
            ...
            <span className='-translate-y-[2px]'>Bỏ qua</span>
          </button>
        </div>
      </form>
    </>
...
export default AdminAddServiceFormComponent
